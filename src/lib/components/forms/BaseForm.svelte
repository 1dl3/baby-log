...
<form class="space-y-6" on:submit|preventDefault={handleSubmit}>
  ...
  <div class="flex items-center mb-6 pb-3 border-b border-gray-200">
    ...
    <h2 class="ml-3 text-lg font-medium text-gray-900">{formTitle} {#if baby}für {baby.name}{/if}</h2>
  </div>
  ...
  <div class="bg-gray-50 p-4 rounded-lg">
    ...
    <div class="mt-2">
      <div class="flex items-center justify-center w-full">
        <label for="photos" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50">
          <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p class="mb-2 text-sm text-gray-500"><span class="font-semibold">Klicke zum Hochladen</span> oder ziehe Dateien hierher</p>
